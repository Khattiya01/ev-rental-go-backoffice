...
export const mockVehicles: Vehicle[] = [
  ...
  { id: '2', plate: 'คง-5678', model: 'Model Y', make: 'Tesla', year: 2022, color: 'Pearl White', status: 'rented', socPercent: 85, odometer: 25300, lat: 13.762, lng: 100.521, imageUrl: 'https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=400', images: [], vin: 'TSLAY987654321', condition: 'Good', location: 'Sukhumvit', nextServiceDate: '2024-09-01', mileage: 25300 },
  { id: '3', plate: 'จฉ-9012', model: 'BYD Atto 3', make: 'BYD', year: 2023, color: 'Red', status: 'charging', socPercent: 45, odometer: 8200, lat: 13.748, lng: 100.493, imageUrl: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=400', images: [], vin: 'BYD345678901', condition: 'Excellent', location: 'Charger Station Rama9', nextServiceDate: '2024-10-20', mileage: 8200 },
  { id: '4', plate: 'ชซ-3456', model: 'Ioniq 5', make: 'Hyundai', year: 2022, color: 'Gravity Gold', status: 'under_repair', socPercent: 30, odometer: 41000, lat: 13.731, lng: 100.511, imageUrl: 'https://images.unsplash.com/photo-1629897048514-3dd7414fe72a?w=400', images: [], vin: 'IONIQ5432109876', condition: 'Fair', location: 'Workshop Ladprao', nextServiceDate: '2024-07-30', mileage: 41000 },
  { id: '5', plate: 'ณด-7890', model: 'MG EP', make: 'MG', year: 2021, color: 'White', status: 'offline', socPercent: 12, odometer: 62000, lat: 13.771, lng: 100.543, imageUrl: 'https://images.unsplash.com/photo-1502877338535-766e1452684a?w=400', images: [], vin: 'MGEP567890123', condition: 'Fair', location: 'Unknown', nextServiceDate: '2024-06-01', mileage: 62000 },
  ...
  { id: '7', plate: 'ทน-6789', model: 'Atto 3', make: 'BYD', year: 2022, color: 'Black', status: 'rented', socPercent: 73, odometer: 37600, lat: 13.758, lng: 100.535, imageUrl: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=400', images: [], vin: 'BYD987654321', condition: 'Good', location: 'On Road', nextServiceDate: '2024-11-01', mileage: 37600 },
]
...
export const mockContracts: Contract[] = [
  { id: '1', contractNo: 'EV-2024-001', customerId: '1', customerName: 'Alex Chen', vehicleId: '2', vehiclePlate: 'คง-5678', startDate: 'Jan 15, 2024', dueDate: 'Feb 14, 2024', depositAmount: 500, dailyRate: 85, monthlyRate: 2100, status: 'overdue', createdAt: '2024-01-15T00:00:00.000Z' },
  { id: '2', contractNo: 'EV-2024-002', customerId: '3', customerName: 'Maria Garcia', vehicleId: '7', vehiclePlate: 'ทน-6789', startDate: 'Jan 20, 2024', dueDate: 'Feb 19, 2024', depositAmount: 500, dailyRate: 90, monthlyRate: 2200, status: 'overdue', createdAt: '2024-01-20T00:00:00.000Z' },
  { id: '3', contractNo: 'EV-2024-003', customerId: '7', customerName: 'สุดา รักดี', vehicleId: '6', vehiclePlate: 'ตถ-2345', startDate: 'Feb 1, 2024', dueDate: 'Mar 1, 2024', depositAmount: 500, dailyRate: 80, monthlyRate: 1900, status: 'active', createdAt: '2024-02-01T00:00:00.000Z' },
  { id: '4', contractNo: 'EV-2024-004', customerId: '1', customerName: 'Alex Chen', vehicleId: '1', vehiclePlate: 'กข-1234', startDate: 'Feb 1, 2024', dueDate: 'May 1, 2024', depositAmount: 1000, dailyRate: 120, monthlyRate: 2500, status: 'active', createdAt: '2024-02-01T00:00:00.000Z' },
  { id: '5', contractNo: 'EV-2024-005', customerId: '3', customerName: 'Maria Garcia', vehicleId: '3', vehiclePlate: 'จฉ-9012', startDate: 'Mar 15, 2024', dueDate: 'Mar 1, 2024', depositAmount: 500, dailyRate: 90, monthlyRate: 1900, status: 'active', createdAt: '2024-03-15T00:00:00.000Z' },
]
