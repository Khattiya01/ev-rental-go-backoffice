...
export const mockVehicles: Vehicle[] = [
  { id: '1', plate: 'กข-1234', model: 'Model 3', make: 'Tesla', year: 2023, color: 'Deep Blue Metallic', status: 'available', socPercent: 70, odometer: 12450, lat: 13.756, lng: 100.502, imageUrl: 'https://images.unsplash.com/photo-1560958089-b8a1929cea89?w=400', vin: 'T3SLA123456789', condition: 'Excellent', location: 'Bangkok Central', nextServiceDate: '2024-08-15', mileage: 12450 },
  { id: '2', plate: 'คง-5678', model: 'Model Y', make: 'Tesla', year: 2022, color: 'Pearl White', status: 'rented', socPercent: 85, odometer: 25300, lat: 13.762, lng: 100.521, imageUrl: 'https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=400', vin: 'TSLAY987654321', condition: 'Good', location: 'Sukhumvit', nextServiceDate: '2024-09-01', mileage: 25300 },
  { id: '3', plate: 'จฉ-9012', model: 'BYD Atto 3', make: 'BYD', year: 2023, color: 'Red', status: 'charging', socPercent: 45, odometer: 8200, lat: 13.748, lng: 100.493, imageUrl: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=400', vin: 'BYD345678901', condition: 'Excellent', location: 'Charger Station Rama9', nextServiceDate: '2024-10-20', mileage: 8200 },
  { id: '4', plate: 'ชซ-3456', model: 'Ioniq 5', make: 'Hyundai', year: 2022, color: 'Gravity Gold', status: 'under_repair', socPercent: 30, odometer: 41000, lat: 13.731, lng: 100.511, imageUrl: 'https://images.unsplash.com/photo-1629897048514-3dd7414fe72a?w=400', vin: 'IONIQ5432109876', condition: 'Fair', location: 'Workshop Ladprao', nextServiceDate: '2024-07-30', mileage: 41000 },
  { id: '5', plate: 'ณด-7890', model: 'MG EP', make: 'MG', year: 2021, color: 'White', status: 'offline', socPercent: 12, odometer: 62000, lat: 13.771, lng: 100.543, imageUrl: 'https://images.unsplash.com/photo-1502877338535-766e1452684a?w=400', vin: 'MGEP567890123', condition: 'Fair', location: 'Unknown', nextServiceDate: '2024-06-01', mileage: 62000 },
  { id: '6', plate: 'ตถ-2345', model: 'Dolphin', make: 'BYD', year: 2023, color: 'Sky Blue', status: 'available', socPercent: 90, odometer: 5100, lat: 13.744, lng: 100.497, imageUrl: 'https://images.unsplash.com/photo-1616788494672-ec7ca25495bf?w=400', vin: 'BYDF123456789', condition: 'Excellent', location: 'Siam Paragon', nextServiceDate: '2025-01-15', mileage: 5100 },
  { id: '7', plate: 'ทน-6789', model: 'Atto 3', make: 'BYD', year: 2022, color: 'Black', status: 'rented', socPercent: 73, odometer: 37600, lat: 13.758, lng: 100.535, imageUrl: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=400', vin: 'BYD987654321', condition: 'Good', location: 'On Road', nextServiceDate: '2024-11-01', mileage: 37600 },
]
...
export const mockContracts: Contract[] = [
  { id: '1', contractNo: 'EV-2024-001', customerId: '1', customerName: 'Alex Chen', vehicleId: '2', vehiclePlate: 'คง-5678', startDate: 'Jan 15, 2024', dueDate: 'Feb 14, 2024', depositAmount: 500, dailyRate: 85, monthlyRate: 2100, status: 'overdue' },
  { id: '2', contractNo: 'EV-2024-002', customerId: '3', customerName: 'Maria Garcia', vehicleId: '7', vehiclePlate: 'ทน-6789', startDate: 'Jan 20, 2024', dueDate: 'Feb 19, 2024', depositAmount: 500, dailyRate: 90, monthlyRate: 2200, status: 'overdue' },
  { id: '3', contractNo: 'EV-2024-003', customerId: '7', customerName: 'สุดา รักดี', vehicleId: '6', vehiclePlate: 'ตถ-2345', startDate: 'Feb 1, 2024', dueDate: 'Mar 1, 2024', depositAmount: 500, dailyRate: 80, monthlyRate: 1900, status: 'active' },
  { id: '4', contractNo: 'EV-2024-004', customerId: '1', customerName: 'Alex Chen', vehicleId: '1', vehiclePlate: 'กข-1234', startDate: 'Feb 1, 2024', dueDate: 'May 1, 2024', depositAmount: 1000, dailyRate: 120, monthlyRate: 2500, status: 'active' },
  { id: '5', contractNo: 'EV-2024-005', customerId: '3', customerName: 'Maria Garcia', vehicleId: '3', vehiclePlate: 'จฉ-9012', startDate: 'Mar 15, 2024', dueDate: 'Mar 1, 2024', depositAmount: 500, dailyRate: 90, monthlyRate: 1900, status: 'active' },
]

export const mockInvoices: Invoice[] = [
  { id: 'INV-1001', contractId: '4', customerName: 'John Doe', amount: 150.00, dueDate: 'Oct 15', status: 'paid', slipUrl: 'https://via.placeholder.com/200x300?text=Payment+Slip' },
  { id: 'INV-1002', contractId: '2', customerName: 'Jane Smith', amount: 220.50, dueDate: 'Oct 20', status: 'pending', slipUrl: 'https://via.placeholder.com/200x300?text=Payment+Slip' },
  { id: 'INV-1003', contractId: '1', customerName: 'Robert Jones', amount: 310.00, dueDate: 'Oct 25', status: 'overdue', daysOverdue: 15, lastContacted: '2 hours ago' },
  { id: 'INV-1004', contractId: '3', customerName: 'John Doe', amount: 150.00, dueDate: 'Oct 15', status: 'paid' },
  { id: 'INV-1005', contractId: '5', customerName: 'Jane Smith', amount: 220.50, dueDate: 'Oct 20', status: 'paid' },
  { id: 'INV-1006', contractId: '4', customerName: 'John Doe', amount: 150.00, dueDate: 'Oct 17', status: 'paid' },
  { id: 'INV-1007', contractId: '1', customerName: 'Maria Garcia', amount: 800.00, dueDate: 'Oct 28', status: 'overdue', daysOverdue: 21, lastContacted: 'Yesterday' },
  { id: 'INV-1008', contractId: '2', customerName: 'Maria Markina', amount: 200.00, dueDate: 'Oct 30', status: 'overdue', daysOverdue: 19, lastContacted: '3 hours ago' },
]
