...
export const customerStatusEnum = pgEnum('customer_status', ['pending_kyc', 'rejected', 'active', 'suspended', 'blacklisted'])
...
export const customers = pgTable('customers', {
  ...
  idCardNumber: varchar('id_card_number', { length: 20 }).unique(),
  ...
  kycNotes: varchar('kyc_notes', { length: 4000 }),
